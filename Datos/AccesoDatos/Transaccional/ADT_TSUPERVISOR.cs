...
{
   public class ADT_TSUPERVISOR : IADT_TSUPERVISOR<ENT_TSUPERVISOR>
    {
        public bool setInsertarTSUPERVISOR(ENT_TSUPERVISOR pEntCab, List<ENT_TRVENTAS_DET> pLisDet, out int pIntRowsAfect)
        {
            int vIntResultado;
            ...
            using (SqlConnection oCN2 = new SqlConnection(conexion.DBCCapaDatos.pStrConString))
            {
                ...
                CMDdet_delete.Parameters.Add(new SqlParameter("@p", SqlDbType.Int)).Value = pEntCab.id_supervisor == null || pEntCab.id_supervisor == 0 ? DBNull.Value : (object)pEntCab.id_supervisor;
                CMDcab_delete.Connection = oCN2;
                CMDcab_delete.Transaction = oTransaction;
                CMDcab_delete.CommandType = CommandType.StoredProcedure;
                CMDcab_delete.CommandText = "SPU_ELIMINAR_TSUPERVISOR" ;
                CMDcab_delete.Parameters.Add(new SqlParameter("@pid_supervisor", SqlDbType.Int)).Value = pEntCab.id_supervisor == null || pEntCab.id_supervisor == 0 ? DBNull.Value : (object)pEntCab.id_supervisor;

                CMDcab_insert.Connection = oCN2;
                CMDcab_insert.Transaction = oTransaction;
                CMDcab_insert.CommandType = CommandType.StoredProcedure;
                CMDcab_insert.CommandText = "SPU_INSERTAR_TSUPERVISOR" ;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pid_supervisor", SqlDbType.Int)).Value = pEntCab.id_supervisor == null || pEntCab.id_supervisor == 0 ? DBNull.Value : (object)pEntCab.id_supervisor;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pc_supervisor", SqlDbType.VarChar)).Value = pEntCab.c_supervisor == null || pEntCab.c_supervisor == "" ? DBNull.Value : (object)pEntCab.c_supervisor;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pt_supervisor", SqlDbType.VarChar)).Value = pEntCab.t_supervisor == null || pEntCab.t_supervisor == "" ? DBNull.Value : (object)pEntCab.t_supervisor;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pt_supervisor_abrev", SqlDbType.VarChar)).Value = pEntCab.t_supervisor_abrev == null || pEntCab.t_supervisor_abrev == "" ? DBNull.Value : (object)pEntCab.t_supervisor_abrev;
                try
                {
                ...
                {
                    oTransaction.Rollback();
                    MessageBox.Show(ex.Message, "ERROR AL INSERTAR EN TSUPERVISOR" ,MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
                finally
                {
        ...
        public bool setActualizarTSUPERVISOR(ENT_TSUPERVISOR pEntCab, List<ENT_TRVENTAS_DET> pLisDet, out int pIntRowsAfect)
        {
            int vIntResultado;
            int vIntResultadoExecute = 0;
            pIntRowsAfect = 0;
            ...
            using (SqlConnection oCN2 = new SqlConnection(conexion.DBCCapaDatos.pStrConString))
            {
                ...
                CMDcab_insert.Transaction = oTransaction;
                CMDcab_insert.CommandType = CommandType.StoredProcedure;
                CMDcab_insert.CommandText = "SPU_ACTUALIZAR_TSUPERVISOR" ;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pid_supervisor", SqlDbType.Int)).Value = pEntCab.id_supervisor == null || pEntCab.id_supervisor == 0 ? DBNull.Value : (object)pEntCab.id_supervisor;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pc_supervisor", SqlDbType.VarChar)).Value = pEntCab.c_supervisor == null || pEntCab.c_supervisor == "" ? DBNull.Value : (object)pEntCab.c_supervisor;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pt_supervisor", SqlDbType.VarChar)).Value = pEntCab.t_supervisor == null || pEntCab.t_supervisor == "" ? DBNull.Value : (object)pEntCab.t_supervisor;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pt_supervisor_abrev", SqlDbType.VarChar)).Value = pEntCab.t_supervisor_abrev == null || pEntCab.t_supervisor_abrev == "" ? DBNull.Value : (object)pEntCab.t_supervisor_abrev;
        ...
        public bool setEliminarTSUPERVISOR(ENT_TSUPERVISOR pEntCab, out int pIntRowsAfect)
        {
            int vIntResultado;
            int vIntResultadoExecute = 0;
            pIntRowsAfect = 0;
