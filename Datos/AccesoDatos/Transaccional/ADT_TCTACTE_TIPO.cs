...
{
   public class ADT_TCTACTE_TIPO : IADT_TCTACTE_TIPO<ENT_TCTACTE_TIPO>
    {
        public bool setInsertarTCTACTE_TIPO(ENT_TCTACTE_TIPO pEntCab, List<ENT_TRVENTAS_DET> pLisDet, out int pIntRowsAfect)
        {
            int vIntResultado;
            ...
            using (SqlConnection oCN2 = new SqlConnection(conexion.DBCCapaDatos.pStrConString))
            {
                ...
                CMDdet_delete.Parameters.Add(new SqlParameter("@p", SqlDbType.Int)).Value = pEntCab.id_ctacte_tipo == null || pEntCab.id_ctacte_tipo == 0 ? DBNull.Value : (object)pEntCab.id_ctacte_tipo;
                CMDcab_delete.Connection = oCN2;
                CMDcab_delete.Transaction = oTransaction;
                CMDcab_delete.CommandType = CommandType.StoredProcedure;
                CMDcab_delete.CommandText = "SPU_ELIMINAR_TCTACTE_TIPO" ;
                CMDcab_delete.Parameters.Add(new SqlParameter("@pid_ctacte_tipo", SqlDbType.Int)).Value = pEntCab.id_ctacte_tipo == null || pEntCab.id_ctacte_tipo == 0 ? DBNull.Value : (object)pEntCab.id_ctacte_tipo;

                CMDcab_insert.Connection = oCN2;
                CMDcab_insert.Transaction = oTransaction;
                CMDcab_insert.CommandType = CommandType.StoredProcedure;
                CMDcab_insert.CommandText = "SPU_INSERTAR_TCTACTE_TIPO" ;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pid_ctacte_tipo", SqlDbType.Int)).Value = pEntCab.id_ctacte_tipo == null || pEntCab.id_ctacte_tipo == 0 ? DBNull.Value : (object)pEntCab.id_ctacte_tipo;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pc_ctacte_tipo", SqlDbType.VarChar)).Value = pEntCab.c_ctacte_tipo == null || pEntCab.c_ctacte_tipo == "" ? DBNull.Value : (object)pEntCab.c_ctacte_tipo;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pt_ctacte_tipo", SqlDbType.VarChar)).Value = pEntCab.t_ctacte_tipo == null || pEntCab.t_ctacte_tipo == "" ? DBNull.Value : (object)pEntCab.t_ctacte_tipo;
                try
                {
                ...
                {
                    oTransaction.Rollback();
                    MessageBox.Show(ex.Message, "ERROR AL INSERTAR EN TCTACTE_TIPO" ,MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
                finally
                {
        ...
        public bool setActualizarTCTACTE_TIPO(ENT_TCTACTE_TIPO pEntCab, List<ENT_TRVENTAS_DET> pLisDet, out int pIntRowsAfect)
        {
            int vIntResultado;
            int vIntResultadoExecute = 0;
            pIntRowsAfect = 0;
            ...
            using (SqlConnection oCN2 = new SqlConnection(conexion.DBCCapaDatos.pStrConString))
            {
                ...
                CMDcab_insert.Transaction = oTransaction;
                CMDcab_insert.CommandType = CommandType.StoredProcedure;
                CMDcab_insert.CommandText = "SPU_ACTUALIZAR_TCTACTE_TIPO" ;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pid_ctacte_tipo", SqlDbType.Int)).Value = pEntCab.id_ctacte_tipo == null || pEntCab.id_ctacte_tipo == 0 ? DBNull.Value : (object)pEntCab.id_ctacte_tipo;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pc_ctacte_tipo", SqlDbType.VarChar)).Value = pEntCab.c_ctacte_tipo == null || pEntCab.c_ctacte_tipo == "" ? DBNull.Value : (object)pEntCab.c_ctacte_tipo;
                CMDcab_insert.Parameters.Add(new SqlParameter("@pt_ctacte_tipo", SqlDbType.VarChar)).Value = pEntCab.t_ctacte_tipo == null || pEntCab.t_ctacte_tipo == "" ? DBNull.Value : (object)pEntCab.t_ctacte_tipo;
                try
        ...
        public bool setEliminarTCTACTE_TIPO(ENT_TCTACTE_TIPO pEntCab, out int pIntRowsAfect)
        {
            int vIntResultado;
            int vIntResultadoExecute = 0;
            pIntRowsAfect = 0;
